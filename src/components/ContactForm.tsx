                        ...
                        <div>
                            ...
                            <div className="mt-12 p-6 bg-gray-50 rounded-2xl">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    ...
                                    <strong>2-4 hours</strong> during business
                                    hours (9 AM - 6 PM EST, Monday-Friday). For
                                    urgent matters, please use WhatsApp or
                                    Telegram for faster response.
                                </p>
                            </div>
